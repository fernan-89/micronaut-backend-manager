...
@Prototype
@Generated("Micronaut")
public final class SerdeAuditLogModel_ChangeDetailDeserializer implements Deserializer<AuditLogModel.ChangeDetail> {
  private static final String KEY_0 = "from";

  private static final Argument ARGUMENT_0 = Argument.STRING.withName(SerdeAuditLogModel_ChangeDetailDeserializer.KEY_0);

  private static final String KEY_1 = "to";

  private static final Argument ARGUMENT_1 = Argument.STRING.withName(SerdeAuditLogModel_ChangeDetailDeserializer.KEY_1);

  private final boolean ignoreUnknown;

  public SerdeAuditLogModel_ChangeDetailDeserializer(@Parameter Deserializer.DecoderContext context, @Parameter Argument type) throws SerdeException {
    this.ignoreUnknown = GeneratedSerdeExceptionUtil.ignoreUnknown(context);
  }

  public Deserializer<AuditLogModel.ChangeDetail> createSpecific(Deserializer.DecoderContext context, Argument type) throws SerdeException {
    return (Deserializer<AuditLogModel.ChangeDetail>) GeneratedSerdeFallbackUtil.withRuntimeObjectFallback(this, context, type);
  }

  public AuditLogModel.ChangeDetail deserialize(Decoder decoder, Deserializer.DecoderContext context, Argument type) throws IOException {
    ...
    while (true) {
      ...
      if (key == null) {
        ...
        return new com.local.app.model.AuditLogModel.ChangeDetail(propertyValue0, propertyValue1);
      }
        ...
        case "from" -> {
          ...
          if (seenProperty0) {
            ...
            try {
              ...
              throw io.micronaut.serde.util.GeneratedSerdeExceptionUtil.withPropertyPath(e0, type, com.local.app.model.SerdeAuditLogModel_ChangeDetailDeserializer.ARGUMENT_0);
            }
          }
        ...
        case "to" -> {
          ...
          if (seenProperty1) {
            ...
            try {
              ...
              throw io.micronaut.serde.util.GeneratedSerdeExceptionUtil.withPropertyPath(e0, type, com.local.app.model.SerdeAuditLogModel_ChangeDetailDeserializer.ARGUMENT_1);
            }
          }
          yield dispatchResult;
        }
